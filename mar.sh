...
wget -O /var/lib/marzban/core/xray.zip "https://github.com/XTLS/Xray-core/releases/download/v24.10.16/Xray-linux-64.zip"  
...
echo "<pre>Setup by AutoScript AixxyCode</pre>" > /var/www/html/index.html
